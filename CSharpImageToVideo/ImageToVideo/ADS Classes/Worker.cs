...
namespace ImageToVideo
{
    class ConfigData
    {
        public double videoTiming { get; set; }
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                try
                {
					...
					string jsonFile = "ImageToVideo.config.json";
                ...
                AdsServer = new AdsImageToVideoServer(config.AdsPort, "ImageToVideoAdsServer", Logger,config.videoTiming);
